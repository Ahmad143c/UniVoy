...
import { People, Business, Chat, Logout } from "@mui/icons-material";
...
const AdminSidebar = ({ activeTab, onTabChange }) => {
  ...
  const menuItems = [
    { text: "Manage Students", icon: <People />, tabIndex: 0 },
    { text: "Manage Consultants", icon: <Business />, tabIndex: 1 },
    { text: "Chat", icon: <Chat />, tabIndex: 2 },
  ];
